...
class RecipeForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.add_input(Submit('submit', 'Submit Recipe', css_class='btn btn-info', id='recipeSubmitButton'))
...
class ReviewForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.add_input(Submit('submit', 'Submit Review', css_class='btn btn-info', id='reviewSubmitButton'))
